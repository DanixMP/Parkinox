"""
Base settings for Parkinox project.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='parkinox'),
...
# Allow CORS for all API paths and WebSocket connections
...
# Total parking capacity (number of spaces)
PARKING_CAPACITY = config('PARKING_CAPACITY', default=100, cast=int)
