...
class TestWhitespaceRemoval:
    ...
    def test_api_format_uppercase_letter_codes(self):
        """API input is uppercased before decode; mixed-case codes must still match."""
        result = normalize_plate("12SAD345IR67")
        assert result == "۱۲ص۳۴۵-۶۷"
        result = normalize_plate("44SIN123IR11")
        assert result == "۴۴س۱۲۳-۱۱"
        result = normalize_plate("21TAXI876IR54")
        assert result == "۲۱ت۸۷۶-۵۴"
